        ...
        <div className="hidden sm:block">
          <div className="flex justify-between items-center text-center py-6 border-t-2 border-gray-300/40">
            <span className="text-sm text-gray-400">
              @copyright 2024 Muhammad || Muiz
            </span>
            <div className="flex items-center justify-center gap-4 mb-4">
              <a href="https://github.com/M-Muiz">
                <FaGithub className="text-4xl" />
              </a>
              <a href="https://www.linkedin.com/in/muhammad-muiz-siddiqui-302287273/">
